...
export default function Orders() {
  ...
  const getPaymentToVendorBadge = (isPaymentDoneToVendor) => {
    if (isPaymentDoneToVendor === true) {
      return <Badge className="bg-[#4A5859]">Completed</Badge>
    } else {
      return <Badge className="bg-yellow-500">Not Completed</Badge>
    }
  }
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead>Payment To Vendor</TableHead>
                ...
                <TableBody>
                  {currentOrders.map((order) => (
                    <TableRow key={order.order_item_id}>
                      ...
                      <TableCell>{getPaymentToVendorBadge(order.is_payment_done_to_vendor)}</TableCell>
                      <TableCell>
                        <Button
                          variant="outline"
                          size="sm"
            ...
            <div className="grid md:grid-cols-2 gap-4 py-4">
              <div>
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div>
                    Payment To Vendor: {getPaymentToVendorBadge(viewDetailsDialog.order.is_payment_done_to_vendor)}
                  </div>
