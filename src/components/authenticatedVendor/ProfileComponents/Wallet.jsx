  ...
  useEffect(() => {
    const fetchWalletData = async () => {
      try {
        ...
        const balanceResponse = await api.get("wallet/vendor/")
        setWalletBalance(balanceResponse.data.wallet_balance)

        // Fetch vendor wallet transactions
        const transactionsResponse = await api.get("wallet/vendor-transactions/")
                ...
                <Table>
                  <TableHeader className="bg-[#4A5859]/5">
                    <TableRow>
                      ...
                      <TableHead>Transaction For</TableHead>
                  ...
                  <TableBody>
                    {currentTransactions.map((transaction, index) => (
                      <TableRow key={index}>
                        ...
                        <TableCell className="font-medium">{transaction.transaction_for}</TableCell>
                        <TableCell>
                          <span
